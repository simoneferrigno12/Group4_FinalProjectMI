...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.up1 = Up(3712, 1792, bilinear)
        ...
        '''
        self.ann1_1 = nn.Linear(94080, 512)
        self.ann1_2 = nn.Linear(512, 7)
        self.ann2_1 = nn.Linear(94080, 512)
        self.ann2_2 = nn.Linear(512, 1)
        '''
        self.ann1_1 = nn.Linear(276480 , 512)
        #self.ann1_1 = nn.Linear(1920 , 512)
        self.ann1_2 = nn.Linear(512, 7)
        self.ann2_1 = nn.Linear(276480 , 512)
        #self.ann2_1 = nn.Linear(1920 , 512)
        self.ann2_2 = nn.Linear(512, 1)
        self.maxpool2d = nn.MaxPool2d(8)
        #self.logsofsoftmax = nn.LogSoftmax(dim=1)
